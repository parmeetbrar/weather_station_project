...
class ModelConverter:
    ...
    def __init__(self, keras_model_path, tflite_model_path):
        """
        Contructor: Initializes the converter with paths for the Keras model and the TFLite model.
        Arguments:  self
    ...
    def load_model(self):
        """
        Method:     Load a Keras model from the specified path
        Arguments:  self
    ...
    def convert_to_tflite(self):
        """
        Method:     Convert the loaded Keras model to TensorFlow Lite format
        Arguments:  self
    ...
    def save_tflite_model(self):
        """
        Method:     Save the converted TFLite model to the specified path
        Arguments:  self
